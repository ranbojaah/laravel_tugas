...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h1>Siswa</h1>
      <button class="btn custom-button"><a href="{{url('/siswa/create')}}" class="text-white">Tambah Data</a></button>
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>{{ $row->goldar }}</td>
            <td class="d-flex">
              <button class="btn custom-button me-2"><a href="{{url('/siswa/'. $row->id . '/edit')}}" class="text-white">Edit</a></button>
